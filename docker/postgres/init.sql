-- Script d'initialisation de la base de données ProjectHub avec données de test
-- Ce script s'exécute automatiquement au premier démarrage du container PostgreSQL

-- Créer la base de données si elle n'existe pas
SELECT 'CREATE DATABASE projecthub'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'projecthub')\gexec
...
-- Attendre que les tables soient créées par Hibernate
-- Ce script sera exécuté après la création des tables

-- Log de confirmation
DO $$
BEGIN
    RAISE NOTICE 'Base de données ProjectHub initialisée avec succès !';
    RAISE NOTICE 'Attente de la création des tables par Hibernate...';
END $$;

-- Attendre un peu pour que Hibernate crée les tables
SELECT pg_sleep(5);
...
BEGIN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'users') THEN
        ...
        -- Insérer les utilisateurs de test (mots de passe en texte clair)
        INSERT INTO users (id, email, password, first_name, last_name, phone, department, role, status, created_at, updated_at) VALUES
        -- Admins
        (1, 'admin@projecthub.com', 'admin123', 'Admin', 'System', '+1234567890', 'IT', 'ADMIN', 'ACTIVE', NOW(), NOW()),
        (2, 'admin2@projecthub.com', 'admin123', 'Sarah', 'Admin', '+1234567891', 'IT', 'ADMIN', 'ACTIVE', NOW(), NOW()),
        
        -- Managers
        (3, 'manager@projecthub.com', 'manager123', 'John', 'Manager', '+1234567892', 'Management', 'MANAGER', 'ACTIVE', NOW(), NOW()),
        (4, 'manager2@projecthub.com', 'manager123', 'Emma', 'Wilson', '+1234567893', 'Management', 'MANAGER', 'ACTIVE', NOW(), NOW()),
        (5, 'manager3@projecthub.com', 'manager123', 'Michael', 'Brown', '+1234567894', 'Management', 'MANAGER', 'ACTIVE', NOW(), NOW()),
        
        -- Développeurs
        (6, 'dev1@projecthub.com', 'dev123', 'Alice', 'Developer', '+1234567895', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (7, 'dev2@projecthub.com', 'dev123', 'Bob', 'Developer', '+1234567896', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (8, 'dev3@projecthub.com', 'dev123', 'Carol', 'Johnson', '+1234567897', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (9, 'dev4@projecthub.com', 'dev123', 'David', 'Smith', '+1234567898', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (10, 'dev5@projecthub.com', 'dev123', 'Eva', 'Garcia', '+1234567899', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (11, 'dev6@projecthub.com', 'dev123', 'Frank', 'Miller', '+1234567900', 'Development', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- Designers
        (12, 'designer@projecthub.com', 'designer123', 'Charlie', 'Designer', '+1234567901', 'Design', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (13, 'designer2@projecthub.com', 'designer123', 'Grace', 'Lee', '+1234567902', 'Design', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (14, 'designer3@projecthub.com', 'designer123', 'Henry', 'Taylor', '+1234567903', 'Design', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- QA Testers
        (15, 'qa@projecthub.com', 'qa123', 'Diana', 'Tester', '+1234567904', 'Quality Assurance', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (16, 'qa2@projecthub.com', 'qa123', 'Ivy', 'Anderson', '+1234567905', 'Quality Assurance', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (17, 'qa3@projecthub.com', 'qa123', 'Jack', 'White', '+1234567906', 'Quality Assurance', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- DevOps
        (18, 'devops1@projecthub.com', 'devops123', 'Kevin', 'Clark', '+1234567907', 'DevOps', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (19, 'devops2@projecthub.com', 'devops123', 'Lisa', 'Rodriguez', '+1234567908', 'DevOps', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- Product Managers
        (20, 'pm1@projecthub.com', 'pm123', 'Mark', 'Davis', '+1234567909', 'Product', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (21, 'pm2@projecthub.com', 'pm123', 'Nancy', 'Martinez', '+1234567910', 'Product', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- Business Analysts
        (22, 'ba1@projecthub.com', 'ba123', 'Oliver', 'Thompson', '+1234567911', 'Business', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        (23, 'ba2@projecthub.com', 'ba123', 'Patricia', 'Garcia', '+1234567912', 'Business', 'MEMBER', 'ACTIVE', NOW(), NOW()),
        
        -- Utilisateurs inactifs pour les tests
        (24, 'inactive1@projecthub.com', 'inactive123', 'Quentin', 'Inactive', '+1234567913', 'Development', 'MEMBER', 'INACTIVE', NOW(), NOW()),
        (25, 'pending1@projecthub.com', 'pending123', 'Rachel', 'Pending', '+1234567914', 'Design', 'MEMBER', 'PENDING', NOW(), NOW())
